export default function Services() {
	return (
		<div className=" bg-slate-300 pt-32 w-full mb-10 px-16 md:px-0">
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10 mt-10 w-screen place-items-center">
				{cardsInfo.map((cardI) => (
					<div className="bg-white rounded-3xl h-80 w-80 p-5 shadow-lg">
